...
class RelaxApp_Structure:
    ...
    def __init__(self, root):
        ...
        self.color_theme = ctk.set_default_color_theme("green")
        ...
        self.frame = ctk.CTkFrame(self.root, height=500, width=350, fg_color="#2b2b2b")
...
class RelaxApp_MessageBox_Structure:
    ...
    def __init__(self, root):
        ...
        # Set a frame at the background.
        self.frame = ctk.CTkFrame(self.window, height=200, width=550, fg_color="#2b2b2b")
        self.frame.pack(pady=10, padx=10, fill="both") 
...
class RelaxApp_Initial_Frame(RelaxApp_Structure):
    ...
    def __init__(self, root):
        ...
        # User label.
        self.user = ctk.CTkLabel(self.frame, text="Usuario", font=(self.font,19))
        self.user.place(rely=0.40, relx=0.5, anchor="center")

        # User entry.
        self.entry_user = ctk.CTkEntry(self.frame,font=(self.font,15), corner_radius=10)
        ...
        # Password label.
        self.password = ctk.CTkLabel(self.frame, text="Contraseña", font=(self.font,19))
        self.password.place(rely=0.54, relx=0.5, anchor="center")

        # Password entry.
        self.entry_password = ctk.CTkEntry(self.frame,font=(self.font,15), corner_radius=10, show="*")
        ...
        # Login button.
        self.button_start = ctk.CTkButton(self.frame, text="Entrar", font=(self.font,20), command= self.sign_in,
        corner_radius=90, width=100, height=20, hover=True, fg_color="#118589", hover_color="#0a4e50")
        self.button_start.place(rely=0.72, relx=0.5, anchor="center")

        # "Register User" button..
        self.button_new_user = ctk.CTkButton(self.frame, width=10, height=10, text="Registrar Usuario", font=(self.font,12), command=self.sign_up,
        corner_radius=10, hover=True, fg_color="#2b2b2b", hover_color="#0a4e50")
        self.button_new_user.place(rely=0.9, relx=0.04)

        # "Forget password" button.
        self.button_forget_pw = ctk.CTkButton(self.frame, width=10, height=10, text="Olvidé contraseña", font=(self.font,12), command=self.change_password,
        corner_radius=10, hover=True, fg_color="#2b2b2b", hover_color="#0a4e50")
    ...
    def sign_in(self):
        ...
        if base_datos.validacion_login:
            ...
            self.error_login = ctk.CTkLabel(self.frame, text="Usuario o contraseña incorrecta. Vuelva a intentarlo.", font=(self.font,11))
...
class RelaxApp_User_Registration(RelaxApp_Structure):
    ...
    def __init__(self, root):
        ...
        self.top_bar = ctk.CTkLabel(self.frame, text=None, fg_color="#0a4e50", width=310, height=0, corner_radius=10)
        self.top_bar.place(rely=0.02, relx=0.03)

        # Bottom bar of the register menu.
        self.bottom_bar = ctk.CTkLabel(self.frame, text=None, fg_color="#0a4e50", width=310, height=0, corner_radius=10)
        self.bottom_bar.place(rely=0.95, relx=0.03)

        # Label of the register menu.
        self.top_text = ctk.CTkLabel(self.frame, text="Complete todos los campos indicados:", font=(self.font,14))
        self.top_text.place(rely=0.08, relx=0.03)

        # Label to register the name.
        self.name = ctk.CTkLabel(self.frame, text="Nombre:", font=(self.font,14))
        self.name.place(rely=0.2, relx=0.03)
       
        # Name entry.
        self.name_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=180, height=10, corner_radius=10)
        ...
        self.last_name = ctk.CTkLabel(self.frame, text="Apellido:", font=(self.font,14))
        self.last_name.place(rely=0.3, relx=0.03)
        
        # Last name entry.
        self.last_name_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=180, height=10, corner_radius=10)
        ...
        self.username = ctk.CTkLabel(self.frame, text="Nombre Usuario:", font=(self.font,14))
        self.username.place(rely=0.4, relx=0.03)
        
        # Username entry.
        self.username_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=180, height=10, corner_radius=10)
        ...
        self.password = ctk.CTkLabel(self.frame, text="Contraseña:", font=(self.font,14))
        self.password.place(rely=0.5, relx=0.03)
        
        # Password entry.
        self.password_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=180, height=10, corner_radius=10, show="*")
        ...
        self.create_button = ctk.CTkButton(self.frame, text="Dar de Alta", font=(self.font,14), command= self.accept_sign_up,
        corner_radius=90, width=100, height=20, hover=True, fg_color="#118589", hover_color="#0a4e50")
        self.create_button.place(rely=0.7, relx=0.5, anchor="center")

        # Button to cancel the user registration.
        self.cancel_button = ctk.CTkButton(self.frame, text="Cancelar", font=(self.font,14), command= self.cancel_sign_up,
        corner_radius=90, width=100, height=20, hover=True, fg_color="#118589", hover_color="#0a4e50")
...
class RelaxApp_User_Change_Password(RelaxApp_Structure):
    ...
    def __init__(self, root):
        ...
        self.name = ctk.CTkLabel(self.frame, text="Nombre Usuario:", font=(self.font,14))
        self.name.place(rely=0.2, relx=0.03)
       
        # Username entry.
        self.name_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=165, height=10, corner_radius=10)
        self.name_entry.place(rely=0.2, relx=0.47)
        self.name_entry.bind("<Button-1>", lambda borrar: self.name_entry.delete(0, tk.END))
       
        # Label to set the new password.
        self.pw1 = ctk.CTkLabel(self.frame, text="Nueva Contraseña:", font=(self.font,14))
        self.pw1.place(rely=0.3, relx=0.03)
        
        # Password entry 1.
        self.pw1_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=165, height=10, corner_radius=10, show="*")
        ...
        self.pw2 = ctk.CTkLabel(self.frame, text="Repetir Contraseña:", font=(self.font,14))
        self.pw2.place(rely=0.4, relx=0.03)
        
        # Password entry 2.
        self.pw2_entry = ctk.CTkEntry(self.frame, font=(self.font,14), width=165, height=10, corner_radius=10, show="*")
        ...
        self.change_pw_button = ctk.CTkButton(self.frame, text="Cambiar Contraseña", font=(self.font,14), command= self.accept_change_pw,
        corner_radius=90, width=100, height=20, hover=True, fg_color="#118589", hover_color="#0a4e50")
        self.change_pw_button.place(rely=0.55, relx=0.5, anchor="center")

        # Button to cancel to change the password.
        self.cancel_change_pw_button = ctk.CTkButton(self.frame, text="Cancelar", font=(self.font,14), command= self.cancel_change_pw,
        corner_radius=90, width=100, height=20, hover=True, fg_color="#118589", hover_color="#0a4e50")
...
class RelaxApp_User_Main_Menu(RelaxApp_Structure):
    ...
    def __init__(self, root):
        ...
        self.frame.configure(fg_color="#242424")
        self.frame.pack(pady=10, padx=0, fill="both")  

        self.frame_top_menu = ctk.CTkFrame(self.frame, height=30, width=350, fg_color="#2b2b2b", corner_radius=3)
...
el usuario indicado?", font=(self.font,14), bg_color="#2b2b2b")
...
del usuario indicado?", font=(self.font,14), bg_color="#2b2b2b")
            self.ask_cancel_label.place(rely=0.3, relx=0.5, anchor="center")
            self.select_button1 = True

        elif message == "Continue":
            # Label confirm user registration.
            self.continue_registration = ctk.CTkLabel(self.window, text=base_datos.mensaje, font=(self.font,14), bg_color="#2b2b2b")
            ...
            self.pw_match = ctk.CTkLabel(self.window, text="¿Está seguro que desea actualizar su contraseña?", font=(self.font,14), bg_color="#2b2b2b")
...
\nVuelva a introducirlas.", font=(self.font,14), bg_color="#2b2b2b")
            ...
            self.pw_ask_cancel_label = ctk.CTkLabel(self.window, text="¿Está seguro que desea cancelar el cambio de contraseña?", font=(self.font,14), bg_color="#2b2b2b")
        ...
        if self.select_button1 == True:
            ...
            self.accept_ask_cancel_button = ctk.CTkButton(self.window, width=80, height=17, text="Aceptar", font=(self.font,14), command=lambda: self.accept_button(message),
            corner_radius=10, hover=True, fg_color="#118589", hover_color="#0a4e50")
            self.accept_ask_cancel_button.place(rely=0.65, relx=0.25, anchor="w")

            # Button to cancel user registration.
            self.cancel_ask_cancel_button = ctk.CTkButton(self.window, width=80, height=17, text="Cancelar", font=(self.font,14), command=self.cancel_button,
            corner_radius=10, hover=True, fg_color="#118589", hover_color="#0a4e50")
        ...
        if self.select_button2 == True:
            ...
            self.continue_registration_button = ctk.CTkButton(self.window, width=80, height=17, text="Continuar", font=(self.font,14), command=self.continue_button,
            corner_radius=10, hover=True, fg_color="#118589", hover_color="#0a4e50")
            self.continue_registration_button.place(rely=0.65, relx=0.5, anchor="center")

        if self.select_button3 == True:
            # Button to continue to the main menu.
            self.continue_registration_button = ctk.CTkButton(self.window, width=80, height=17, text="Volver", font=(self.font,14), command=self.return_button,
            corner_radius=10, hover=True, fg_color="#118589", hover_color="#0a4e50")
            self.continue_registration_button.place(rely=0.65, relx=0.5, anchor="center")
